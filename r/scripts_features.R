...
data <- read.csv('scripts_features.csv')
...
jpeg('scripts_features.jpg')
barplot(y,names.arg=x,xlab="Occurences",ylab="Number of features",main="Occurence of features in scripts")